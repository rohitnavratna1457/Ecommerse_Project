...
import {
  ...
  GettCategoryGet,
  DeleteSubCategory,
} from "../../../Api/CoreApi"; // Import API functions
...
const SubCategoryForm = () => {
  ...
  const handleEdit = (record) => {
    ...
    // Pre-fill the form with the selected subcategory's details
    Form.setFieldsValue({
      name: record.name,
      category: record.category, // Ensure this is the ID
      slug: record.slug,
    ...
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        >
          ...
          <Form.Item label="Status" name="is_status" valuePropName="checked">
